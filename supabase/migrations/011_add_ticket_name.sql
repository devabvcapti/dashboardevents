-- Migration 011: adiciona ticket_name a participants e atualiza RPC de upsert

ALTER TABLE participants ADD COLUMN IF NOT EXISTS ticket_name text;
  ...
  LOOP
    BEGIN
      ...
      INSERT INTO participants (
        ...
        ticket_membership, ticket_value, ticket_name, import_job_id
      ) VALUES (
        p_edition_id,
        v_email,
        v_row->>'full_name',

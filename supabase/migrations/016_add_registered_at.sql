-- Migration 016: adiciona registered_at a participants e atualiza RPC de upsert

ALTER TABLE participants ADD COLUMN IF NOT EXISTS registered_at timestamptz;
